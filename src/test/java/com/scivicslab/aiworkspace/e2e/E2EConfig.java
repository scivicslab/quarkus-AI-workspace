...
class E2EConfig {
    ...
    static Path configYaml() throws Exception {
        URL url = E2EConfig.class.getClassLoader().getResource("ai-workspace-test.yaml");
        if (url == null) throw new IllegalStateException("ai-workspace-test.yaml not found on classpath");
